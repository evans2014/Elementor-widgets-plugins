...
add_action('elementor/widgets/register', function($widgets_manager) {
    ...
    require_once plugin_dir_path(__FILE__) . 'includes/elementor/class-shipment-grid-widget.php';
    require_once plugin_dir_path(__FILE__) . 'includes/elementor/class-shipment-single-widget.php';
    require_once plugin_dir_path(__FILE__) . 'includes/elementor/class-shipment-timeline-widget.php';

    $widgets_manager->register(new \Shipment_Grid_Widget());
    $widgets_manager->register(new \Shipment_Single_Widget());
    $widgets_manager->register(new \Shipment_Timeline_Widget());
    ...
    public function render_shipment_meta_box($post) {
        ...
        <div class="two-columns">
            ...
            <div class="right-column">
                    <p>
                        <label><?php _e('Tracking Number ( auto generate )', 'shipment-manager'); ?></label><br/>
                        <input type="text" name="shipment_tracking_number" value="<?php echo esc_attr(get_post_meta($post->ID, '_shipment_tracking_number', true)); ?>" style="width:100%;" readonly />
                    </p>
                    <p>
...
add_action('elementor/dynamic_tags/register', function($dynamic_tags) {
    ...
    class Shipment_Meta_Tag extends \Elementor\Core\DynamicTags\Tag {
        ...
        protected function register_controls() {
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        '_shipment_tracking_number' => 'Tracking Number',
                        '_shipment_status'          => 'Status',
                        '_total_time'               => 'Total Time',
                        '_courier_name'             => 'Courier Name',
                        '_courier_phone'            => 'Courier Phone',
                        '_courier_message'          => 'Courier Message',
                    ],
                ]
            );
        }
    ...
    $dynamic_tags->register(new Shipment_Meta_Tag());
});
